...
all_features = np.array(['child', 'adult', 'solitary', 'Multiple', 'solid', 
'solid_necrosis', 'cystic', 'Caseating', 'flow', 'whole', 'wall', 'Hemorrhage', 'Popcorn', 
'Calcification', 'fat', 'Diffusion', 'DIffusion_cavity', 
'oedema', 'Basal', 'peri', 'brain_stem', 'striated'], dtype=object)
